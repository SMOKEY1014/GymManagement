...
using GymManagement.Data.Migrations;
    ...
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create(LeaveType leaveType)
        {
            if (ModelState.IsValid)
            {
                ...
                leaveType.CreatedById = "SMOKEY1014";
        ...
        public async Task<IActionResult> Edit(int id, LeaveType leaveType)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    leaveType.ModifiedById = "SMOKEY1014";
                ...
                {
                    Console.WriteLine("Model State is NOT Valid!!, Caugth an error");
